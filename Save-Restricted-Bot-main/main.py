...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("OWNER ✅", url="https://t.me/bl44ze")]]), reply_to_message_id=message.id)
...
```                   
**JOIN OUR CHANNEL TO SUPPORT US AND GET BEST BOTS FOR FREE**
